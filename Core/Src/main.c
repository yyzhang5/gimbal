...
static void MX_TIM1_Init(void)
{
  ...
  sMasterConfig.MasterOutputTrigger = TIM_TRGO_UPDATE;  //! 后增加 TIM1 输出 TRGO
...
static void MX_TIM8_Init(void)
{
  ...
  sMasterConfig.MasterOutputTrigger = TIM_TRGO_UPDATE;  //! 后增加为了ADC采集 TIM8 输出 TRGO
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : PM1_ENC_DAT_Pin */
  GPIO_InitStruct.Pin = PM1_ENC_DAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PM1_ENC_DAT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PM2_ENC_DAT_Pin */
  GPIO_InitStruct.Pin = PM2_ENC_DAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PM2_ENC_DAT_GPIO_Port, &GPIO_InitStruct);
...
/**
  * @brief  ??????(?????)
  * @param  GPIO_Pin: KEY0_Pin / KEY1_Pin / KEY2_Pin
  * @retval 1:???????
  */
